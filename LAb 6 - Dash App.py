...
app.layout = html.Div(children=[html.H1('IH2 - SpaceX Launch Records Dashboard',
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Total Sucess Launches by site - IH')
        return fig
    else:
...
def get_scatter_chart(entered_site, entered_payload):
    ...
    fig = px.scatter(filtered_df2, x="Payload Mass (kg)", y="class", color = "Booster Version Category",
                 hover_name="Payload Mass (kg)", title='Correlation between payload and success for' + entered_site, size_max=60)
    return fig
